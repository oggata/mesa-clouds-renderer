...
function makeGable(fp){
  ...
  // ★ 屋根の上には何も載せない。以前は棟の線を崩すために煙突 (箱) を立てて
  //   いたが、勾配の途中から棟の高さ近くまで伸びるので、斜めの屋根から立方体が
  //   突き出しているようにしか見えなかった。三角屋根の輪郭は三角のままにする。
  //   屋上看板も server.js 側で三角屋根には載らないようになっている
  //   (structVariant の V.gable)。
  return m;
}
